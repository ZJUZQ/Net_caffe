...
def evalCOCO(detectImgs, jsonFile, savedImgPath): 
    ...
    for i in range(len(detectImgs)): ## iterate all val images
        ...
        pred[i]['image_id'] = int(imgPath.split('/')[-1].split('.')[0][-12:]) ## COCO_val2014_000000001233.jpg --> 1233
        ...
        for ridxPred in range(len(subset)):
            ...
            for part in range(18):
                ...
                if (index > 0):
                    ...
                    point[part_cnt]['id'] = orderCOCO[part] - 1 ## index from 0
                    ##point[part_cnt]['id'] = orderCOCO[part] ## index from 1
                    part_cnt = part_cnt + 1
    ...
    print 'write json file: {}'.format(jsonFile)
