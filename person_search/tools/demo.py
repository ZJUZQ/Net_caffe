...
def main(args):
    ...
    query_img = 'demo/ali_query.jpg'
    query_roi = [576, 130, 790, 642]
    ...
    query_feat = demo_exfeat(net, filename=query_img, roi=query_roi) # Extract feature for a probe person ROI in an image
