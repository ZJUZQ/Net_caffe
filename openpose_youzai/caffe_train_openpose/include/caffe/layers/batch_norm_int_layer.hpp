#ifndef CAFFE_BATCHNORM_INT_LAYER_HPP_
#define CAFFE_BATCHNORM_INT_LAYER_HPP_
...
class BatchNormIntLayer : public Layer<Dtype> {
 public:
  explicit BatchNormIntLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "BatchNormINT"; }
 ...
 protected:
  ...
  Blob<Dtype> mean_, min_, max_, range_, variance_, temp_, x_norm_;
...
#endif  // CAFFE_BATCHNORM_INT_LAYER_HPP_
