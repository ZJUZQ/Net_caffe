...
void DepthwiseConvolutionNormLayer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void DepthwiseConvolutionNormLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void DepthwiseConvolutionNormLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void DepthwiseConvolutionNormLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(DepthwiseConvolutionNormLayer);
#endif

INSTANTIATE_CLASS(DepthwiseConvolutionNormLayer);
REGISTER_LAYER_CLASS(DepthwiseConvolutionNorm);
}  // namespace caffe
