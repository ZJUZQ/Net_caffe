...
data_dirname = os.path.abspath(os.path.join(file_dirname, '../data/flickr_style'))
...
if __name__ == '__main__':
    ...
    csv_filename = os.path.join(file_dirname, 'flickr_style.csv.gz')
    ...
    if data_dirname is None:
        data_dirname = os.path.abspath(os.path.join(file_dirname, '../data/flickr_style'))
    images_dirname = os.path.join(data_dirname, 'images')
    ...
    for split in ['train', 'test']:
        ...
        filename = os.path.join(data_dirname, '{}.txt'.format(split))
